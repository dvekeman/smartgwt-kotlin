 ...
 */
open external class TreePalette : TreeGrid, Palette {
    /**
     *  Defaults to apply to all components originating from this palette.
     *  @type {object}
     *  @default null
     */
    open var componentDefaults: dynamic = definedExternally
    /**
    ...
    companion object {
        /**
         *  Creates a new TreePalette
         * 
         *  @param typeCheckedProperties {Partial<TreePalette>=} Object literal containing init properties that will be checked against the class field types.
         *  @param uncheckedProperties {Object} Object literal containing init properties that will not be checked against the class field types.
         *  @return {TreePalette} The new instance
         */
        fun create(typeCheckedProperties: dynamic?, uncheckedProperties: Object?): TreePalette = definedExternally
    }
}